//
BaiCao.BaiCaoEndGame = BaseLayer.extend({

    ctor: function()
    {
        this._super("BaiCaoEndGame");
        //this.initWithBinaryFile("res/g_res_cardGame_json_BaCayEndGame.json");
        cc.log("BaiCaoEndGame ctor end");
        this.data = [];
    ...
    customizeGUI2: function()
    {
        ...
        this.panels = [];
        var sprite = GuiUtil.createSprite(BaiCao.res.endGameItemSlot);//new cc.Sprite(BaiCao.res.endGameItemSlot);
    ...
    tableCellSizeForIndex:function (table, idx) {
        //var sprite = new cc.Sprite(BaiCao.res.endGameItemSlot);
        var sprite = GuiUtil.createSprite(BaiCao.res.endGameItemSlot);
    ...
    tableCellAtIndex:function (table, idx) {
        ...
        var item = new BaiCaoEndGameItem(idx + 1, player.name, player.tongTienCuoc, player.tongDanhBien, player.tongKeCua, player.tongCuocGa, player.tongCuoiVan);
