//
BaiCao.EffectLayer = cc.Layer.extend({
    ctor: function(){
        this._super();
    ...
    chiaBai: function(player, num, stt){
        ...
        var cardImg = GuiUtil.createSprite(BaiCao.res.laBaiChe);//new cc.Sprite(BaiCao.res.laBaiChe);
        //tao dealer
        ...
        var timeOffsetAppear = 0.003*timeSlow;
        {
            if(player.index == 0) {
                for ( var i = 0; i < num * 3; i++) {
                    var card = GuiUtil.createSprite(BaiCao.res.laBaiChe);//new cc.Sprite(BaiCao.res.laBaiChe);
                    card.setScale(0.75);
            ...
            for(var i = 0; i < 3; i++){
                var mycard  = GuiUtil.createSprite(BaiCao.res.laBaiChe);//new cc.Sprite(BaiCao.res.laBaiChe);
    ...
    addPhatLuong: function(){
        ...
        var effect = GuiUtil.createSprite(BaiCao.res.phatLuongPng);//new cc.Sprite(BaiCao.res.phatLuongPng);
    ...
    addCaLangSangTien: function(){
        var winSize = SceneMgr.getInstance().getRunningScene().getMainContentSize();
        var effect = GuiUtil.createSprite(BaiCao.res.caLangSangTienPng);//new cc.Sprite(BaiCao.res.caLangSangTienPng);
        effect.setPosition(winSize.width/2, winSize.height/2 + 100);
        this.addChild(effect);
    ...
    firstTurn: function(player){
        var winSize = SceneMgr.getInstance().getRunningScene().getMainContentSize();
        var layerCard = GuiUtil.createSprite(BaiCao.res.cardFirstTurnPng);//new cc.Sprite(BaiCao.res.cardFirstTurnPng);
    ...
    anGa: function(from, to){
        ...
        for(var i = 0; i < 4; i++){
            ...
            var star = GuiUtil.createSprite("res/CardGame/BaCay/star.png");//new cc.Sprite("res/CardGame/BaCay/star.png");
        ...
        anGaImg.runAction(cc.sequence(cc.EaseBackOut.create(cc.moveTo(1.0, to)), cc.delayTime(8.0), cc.hide()));
    },
