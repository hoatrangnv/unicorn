...
var MinigameLayer = BaseLayer.extend(
    {
        ...
        actionHideMiniGame: function()
        {
            ...
            this.pMiniGame.runAction(cc.sequence( cc.spawn(cc.scaleTo(0.35,0),cc.rotateTo(0.35,180)),cc.callFunc(function(){Minigame.isShow = false;Minigame.img_center.setVisible(true);Minigame.btn_minigame.setEnabled(true);})));
            this.pNenMiniGame.setVisible(false);
            cc.eventManager.pauseTarget(this.pNenMiniGame, true);
        },
