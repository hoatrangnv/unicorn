//
Lieng.CardSprite = cc.Sprite.extend({
    ctor: function (id) {
        this._super(Lieng.res.cardNamePath + 51 + ".png");
        this.id = id;
      ...
      //  this.setTexture(cc.textureCache.addImage(this.getResource(this.id)));
        ...
        this.startY = 0;
        this.isUp = false;
        //this.anhSang = new cc.Sprite("res/CardGame/Lieng/anhSang.png");
    ...
    containTouchPoint2: function(touchPoint) {
        var localPoint = this.convertToNodeSpaceAR(touchPoint);
        var rect = this.getContentSize();
        var rect2 = new cc.rect(0, -rect.height/2, rect.width, rect.height);
        return cc.rectContainsPoint(rect2, localPoint);
    },

    getResource: function(id){
        if(id >= 52 || id < 0){
            return "res/CardGame/BoBaiPoker/labai_52.png";
        }

        var realId = Lieng.Card.getDisplayId(id);
        return Lieng.res.cardNamePath + realId + ".png";
    },
    ...
    runToInitPosition: function(){
        this.stopAllActions();
        this.runAction(cc.moveTo(0.1, cc.p(this.rootPosition.x, this.rootPosition.y)));
    },
...
Lieng.CardSprite.getResource = function(id){
    if(id >= 52 || id < 0){
        return "res/CardGame/BoBaiPoker/labai_52.png";
    }
