...
CoUp.CmdReceiveLogin = CmdReceivedCommon.extend({
    ctor :function(pkg)
    {
        this._super(pkg);
        this.readData();
...
CoUp.ReceiveJoinRoomFail = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.ReceiveCauHoaSuccess = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.ReceiveCauHoaFail = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.ReceiveJoinRoomSucceed = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.ReceiveAutoStart = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.ReceivedSitting = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.ReceivedStartGame = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.ReceiveUserLeaveRoom = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.ReceiveUserJoinRoom = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.CmdReceiveNotifyRegOutRoom = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.CmdReceivedKickOff = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.CmdReceivePingPong = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.CmdReceivedChangeTurn = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.CmdReceivedTakeTurn = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
    readData: function(){
        ...
        this.result = this.getByte();
        this.isTrans = this.getBool();
        if (this.isTrans) {
            this.newPiece = this.getString();
        }
    }
});

CoUp.CmdReceivedEndGame = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.CmdReceivedCauHoaResponse = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.CmdReceivedKhieuChien = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.CmdReceivedKhieuChienResponse = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.CmdReceivedUpdateMatch = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
...
CoUp.CmdReceivedRoomInfo = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
    ...
    readData: function(){
        ...
        var row = this.getShort();
        this.statusMap = new Array(row);
        for (var i = 0; i < row; i++) {
            var col = this.getShort();
            this.statusMap[i] = new Array(col);
            for (var j = 0; j < col; j++) {
                this.statusMap[i][j] = this.getByte();
            }
        }
    }
});

CoUp.CmdReceivedReconnect = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
    ...
    readData: function(){
        ...
        this.danhSachQuanAn = [];
        for (var i = 0; i < len; i++)
            this.danhSachQuanAn.push(this.getString());
    }
});

CoUp.CmdThongTinQuanAn = CmdReceivedCommon.extend({
    ctor: function(pkg){
        this._super(pkg);
        this.readData();
    },
