//
Sam.CardSprite = cc.Sprite.extend({
    ctor: function (id) {
        this._super(Sam.res.cardNamePath + 51 + ".png");
        this.id = id;
    ...
    getResource: function(id){
        if(this.id < 52){
            return Sam.res.cardNamePath + this.convertId(id)+ ".png";
        }
        return "res/CardGame/LaBai/labai_52.png";
    }
});

Sam.CardSprite.getResource = function(id){
    if(id < 52){
        return Sam.res.cardNamePath + (id)%52 + ".png";
    }
    return "res/CardGame/LaBai/labai_52.png";
}
