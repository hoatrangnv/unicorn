//
XiZach.CardSprite = cc.Sprite.extend({
    ctor: function (id) {
        this._super(XiZach.res.cardNamePath + 51 + ".png");
        this.id = id;
        ...
        this.startY = 0;
        this.isUp = false;
        //this.anhSang = new cc.Sprite("res/CardGame/XiZach/anhSang.png");
    ...
    getResource: function(id){
        ...
        var realId = XiZach.Card.getDisplayId(id);
        return XiZach.res.cardNamePath + realId + ".png";
    },
...
XiZach.CardSprite.getResource = function(id){
    if(id >= 52 || id < 0){
        return "res/CardGame/LaBai/labai_52.png";
    }
