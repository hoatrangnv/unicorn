(function () {
    ...
    var SociallManager = uc.Network.SociallManager = cc.Class.extend({
        ...
        loginGoogle: function () {
            ...
            if (cc.sys.os == cc.sys.OS_ANDROID) {
                jsb.reflection.callStaticMethod("Vinplay/Google", "accessToken", "()V");
            }
        ...
        loginFacebook: function () {
            ...
            if (cc.sys.os == cc.sys.OS_ANDROID) {
                jsb.reflection.callStaticMethod("vinplay/Facebook", "ccessToken", "()V");
            }
    ...
    var SocialManager = uc.Network.SocialManager = cc.Class.extend({
