(function () {
    ...
    var sendRequest = uc.Network.request;
    var fonts = uc.fonts;
    var gameListSlot =
        [
            {
    ...
    var LobbyLayer = uc.LobbyLayer = uc.BaseLayer.extend({
            ctor: function () {
                this.arrBtnMenu = [];
                this.save_username = "";
                this.save_password = "";
            ...
            initPDangKy: function () {
                this.addLayout(this, "pDangKy", cc.p(640, 360), res_Lobby + "/DangKy/bg_DangKy.jpg", cc.size(1280, 720), true);
                this.addEditBox(this.pDangKy, "tf_user_name_dk", cc.p(715, 487), "", "Tên đăng nhập", fonts.RobotoRegular.fontName, 20, cc.size(250, 46), null, cc.TEXT_ALIGNMENT_LEFT, 16);
                this.tf_user_name_dk.setFontColor(cc.color.BLACK);
                this.addEditBox(this.pDangKy, "tf_mat_khau_dk", cc.p(715, 429), "", "Mật khẩu", fonts.RobotoRegular.fontName, 20, cc.size(250, 46), null, cc.TEXT_ALIGNMENT_LEFT, 16);
                this.tf_mat_khau_dk.setInputFlag(cc.EDITBOX_INPUT_FLAG_PASSWORD);
                this.tf_mat_khau_dk.setFontColor(cc.color.BLACK);
                this.addEditBox(this.pDangKy, "tf_nhap_lai_mk_dk", cc.p(715, 369), "", "Nhập lại mật khẩu", fonts.RobotoRegular.fontName, 20, cc.size(250, 46), null, cc.TEXT_ALIGNMENT_LEFT, 16);
                this.tf_nhap_lai_mk_dk.setFontColor(cc.color.BLACK);
                this.tf_nhap_lai_mk_dk.setInputFlag(cc.EDITBOX_INPUT_FLAG_PASSWORD);
                this.addEditBox(this.pDangKy, "tf_ma_xac_nhan_dk", cc.p(614, 310), "", "Mã xác nhận", fonts.RobotoRegular.fontName, 20, cc.size(127, 46), null, cc.TEXT_ALIGNMENT_CENTER, 3);
            ...
            initPContent: function () {
                ...
                this.addText(this.pAccount, "lb_hotline", cc.p(1042, 39), "Hotline: " + LobbyLayer.hotLine, fonts.RobotoRegular.fontName, 24);
                ...
                this.addEditBox(this.pn_chat, "tf_chat_lobby", cc.p(100, 33), "", "Bạn cần VP để chat", fonts.RobotoRegular.fontName, 15, cc.size(153, 27), null, cc.TEXT_ALIGNMENT_LEFT, 16);
            ...
            initPTaoNhanVat: function () {
                ...
                this.addText(this.pTaoNhanVat, "lb_title_tao_nhan_vat", cc.p(640, 464), "TÊN NHÂN VẬT", fonts.RobotoRegular.fontName, 30);
                ...
                this.addText(this.pTaoNhanVat, "lb_tt_bat_buoc", cc.p(640, 428), "(*) Thông tin bắt buộc", fonts.RobotoRegular.fontName, 20);
                this.addEditBox(this.pTaoNhanVat, "tf_tao_ten_nhan_vat", cc.p(640, 381), "", "Tên nhân vật", fonts.RobotoRegular.fontName, 24, cc.size(357, 50), res_Lobby + "/bg_2.png", cc.TEXT_ALIGNMENT_CENTER, 16);
                ...
                this.addText(this.pTaoNhanVat, "lb_tt_bat_buoc", cc.p(640, 328), "(*) Tên nhân vật trong khoảng từ 6-16 ký tự, không chứa các ký tự nhạy cảm,"
                    + "\nký tự đặc biệt và không có khoảng trắng", fonts.RobotoRegular.fontName, 15);
            ...
            initPLoginOTP: function () {
                ...
                this.addText(this.pn_login_otp, "lb_title_login_otp", cc.p(640, 647), "TÊN NHÂN VẬT", fonts.RobotoRegular.fontName, 38);
                this.lb_title_login_otp.setColor(cc.color(162, 105, 64));
                this.addText(this.pn_login_otp, "lb_nhap_ma_otp", cc.p(640, 527), "NHẬP MÃ OTP", fonts.RobotoRegular.fontName, 30);
                this.addText(this.pn_login_otp, "lb_txt_content", cc.p(640, 473), "Bạn đang sử dụng tính năng bảo mật bằng OTP."
                    + "\nVui lòng nhập OTP để đăng nhập", fonts.RobotoRegular.fontName, 24);
                ...
                this.addText(this.pn_login_otp, "txt_sms_otp_lobby", cc.p(640, 395), "SMS OTP", fonts.RobotoRegular.fontName, 25);
                this.txt_sms_otp_lobby.setColor(cc.color.GRAY);

                this.addEditBox(this.pn_login_otp, "tf_login_otp", cc.p(640, 303), "", "Nhập mã xác thực", fonts.RobotoRegular.fontName, 24, cc.size(357, 50), res_Lobby + "/bg_2.png", cc.TEXT_ALIGNMENT_CENTER, 5);
                this.tf_login_otp.setFontColor(cc.color.BLACK);
                this.addText(this.pn_login_otp, "text_conten_otp1", cc.p(277, 236), "SMS OTP : ", fonts.RobotoRegular.fontName, 24);
                this["text_conten_otp1"].setColor(cc.color(243, 13, 241));
                this.addText(this.pn_login_otp, "text_conten_otp2", cc.p(654, 236), "Vui lòng soạn tin                  gửi            để nhận mã xác thực", fonts.RobotoRegular.fontName, 24);
                this.addText(this.pn_login_otp, "text_conten_otp3", cc.p(581, 236), "VIN OTP", fonts.RobotoRegular.fontName, 24);
                this["text_conten_otp3"].setColor(cc.color(243, 13, 241));
                this.addText(this.pn_login_otp, "text_conten_otp4", cc.p(703, 236), LobbyLayer.SMS_OTP, fonts.RobotoRegular.fontName, 24);
                this["text_conten_otp4"].setColor(cc.color(243, 13, 241));
                this.addText(this.pn_login_otp, "text_conten_otp5", cc.p(277, 198), "APP OTP : ", fonts.RobotoRegular.fontName, 24);
                this["text_conten_otp5"].setColor(cc.color(243, 13, 241));
                this.addText(this.pn_login_otp, "text_conten_otp6", cc.p(699, 198), "Nếu bạn đã cài APP OTP. Vui lòng bật APP OTP để lấy mã xác thực", fonts.RobotoRegular.fontName, 24);
            ...
            initPForgetPass: function () {
                ...
                this.addText(this.pn_forget_pass, "lb_title_forget_pass", cc.p(640, 647), "QUÊN MẬT KHẨU", fonts.RobotoRegular.fontName, 38);
                ...
                this.addText(this.pn_otp_forget, "lb_txt_forget_content", cc.p(640, 473), "Tài khoản đã đăng ký bảo mật."
                    + "\nVui lòng nhập OTP để được hỗ trợ nhanh nhất", fonts.RobotoRegular.fontName, 24);
                ...
                this.addText(this.pn_otp_forget, "txt_otp_forget", cc.p(640, 409), "SMS OTP", fonts.RobotoRegular.fontName, 25);
                this.txt_otp_forget.setColor(cc.color.GRAY);
                this.addEditBox(this.pn_otp_forget, "tf_input_otp_for", cc.p(640, 316), "", "Nhập mã xác thực", fonts.RobotoRegular.fontName, 24, cc.size(357, 50), res_Lobby + "/bg_2.png", cc.TEXT_ALIGNMENT_CENTER, 5);
                this.tf_input_otp_for.setFontColor(cc.color.BLACK);
                this.addText(this.pn_otp_forget, "text_conten_otp7", cc.p(277, 249), "SMS OTP : ", fonts.RobotoRegular.fontName, 24);
                this["text_conten_otp7"].setColor(cc.color(243, 13, 241));
                this.addText(this.pn_otp_forget, "text_conten_otp8", cc.p(654, 249), "Vui lòng soạn tin                  gửi            để nhận mã xác thực", fonts.RobotoRegular.fontName, 24);
                this.addText(this.pn_otp_forget, "text_conten_otp9", cc.p(581, 249), "VIN OTP", fonts.RobotoRegular.fontName, 24);
                this["text_conten_otp9"].setColor(cc.color(243, 13, 241));
                this.addText(this.pn_otp_forget, "text_conten_otp10", cc.p(703, 249), LobbyLayer.SMS_OTP, fonts.RobotoRegular.fontName, 24);
                this["text_conten_otp10"].setColor(cc.color(243, 13, 241));
                this.addText(this.pn_otp_forget, "text_conten_otp11", cc.p(277, 210), "APP OTP : ", fonts.RobotoRegular.fontName, 24);
                this["text_conten_otp11"].setColor(cc.color(243, 13, 241));
                this.addText(this.pn_otp_forget, "text_conten_otp12", cc.p(699, 210), "Nếu bạn đã cài APP OTP. Vui lòng bật APP OTP để lấy mã xác thực", fonts.RobotoRegular.fontName, 24);
                ...
                this.addText(this.pn_email_forget, "lb_txt_email_content", cc.p(640, 483), "Tài khoản kích hoạt bảo mật bằng Email."
                    + "Xin vui lòng nhập chính xác Email dùng để bảo mật!", fonts.RobotoRegular.fontName, 24);
                ...
                this.addEditBox(this.pn_email_forget, "tf_input_email_for", cc.p(640, 360), "", "Nhập Email:", fonts.RobotoRegular.fontName, 24, cc.size(357, 50), res_Lobby + "/bg_2.png", cc.TEXT_ALIGNMENT_LEFT, 100);
                ...
                this.addText(this.pn_otp_information, "lb_txt_information_content", cc.p(640, 486), "Để nhận được hỗ trợ."
                    + "Vui lòng nhập đầy đủ các thông tin dưới đây:", fonts.RobotoRegular.fontName, 24);
                ...
                this.addEditBox(this.pn_otp_information, "tf_username_for", cc.p(640, 396), "", "Nhập tên đăng nhập:", fonts.RobotoRegular.fontName, 24, cc.size(357, 50), res_Lobby + "/bg_2.png", cc.TEXT_ALIGNMENT_LEFT, 16);
                this.tf_username_for.setFontColor(cc.color.BLACK);
                this.addEditBox(this.pn_otp_information, "tf_captcha_forget", cc.p(555, 290), "", "Mã xác nhận", fonts.RobotoRegular.fontName, 24, cc.size(178, 50), res_Lobby + "/bg_2.png", cc.TEXT_ALIGNMENT_CENTER, 5);
                ...
                this.addText(this.content_bm, "lb_txt_otp_thongbao1", cc.p(640, 360), "Hệ thống đã ghi nhận thông báo của quý khách."
                    ...
                    + "\n\nVui lòng kiểm tra Email và số điện thoại đã kích hoạt bảo mật!", fonts.RobotoRegular.fontName, 24);
                ...
                this.addText(this.content_bm, "txt_content_td_1_0", cc.p(515, 102), LobbyLayer.hotLine, fonts.RobotoRegular.fontName, 20);
                this["txt_content_td_1_0"].setColor(cc.color(243, 13, 241));
                this["txt_content_td_1_0"].setSkewX(15);
                this.addText(this.content_bm, "txt_content_td_fo_1_0", cc.p(459, 102), "*** Mọi thắc mắc xin liên hệ tổng đài                    để được hỗ trợ trực tiếp!", fonts.RobotoRegular.fontName, 20);
                ...
                this.addText(this.content_no_bm, "lb_txt_content_no_bm", cc.p(640, 360), "Tài khoản chưa đăng ký sử dụng chức năng bảo mật. "
                    + "\nXin vui lòng liên hệ đến tổng đài                     để được hỗ trợ!", fonts.RobotoRegular.fontName, 24);
                ...
                this.addText(this.content_no_bm, "lb_txt_content_no_bm2", cc.p(730, 344), LobbyLayer.hotLine, fonts.RobotoRegular.fontName, 24);
                ...
                this.addText(this.content_no_bm, "lb_txt_content_no_bm3", cc.p(626, 106), "*** Trường hợp các tài khoản đã đăng ký sử dụng chức năng bảo mật. Hệ thống sẽ tự động kiểm tra, hỗ trợ "
                    + "\nmột cách nhanh chóng và thuận tiện hơn", fonts.RobotoRegular.fontName, 20);
                ...
                this.addText(this.pn_chose_email_otp, "lb_txt_chose_email_otp", cc.p(640, 462), "Tài khoản đã đăng ký bảo mật bằng Email và số điện thoại."
                    ...
                    + "\nVui lòng lựa chọn hình thức lấy lại mật khẩu", fonts.RobotoRegular.fontName, 24);
                ...
                this.addText(this.pn_chose_email_otp, "txt_email_sms_for", cc.p(640, 356), "Qua số điện thoại", fonts.RobotoRegular.fontName, 25);
            ...
            initPBaoTri: function () {
                ...
                this.addText(this.pn_baotriHeThong, "lb_baotri1", cc.p(640, 360), "BẢO TRÌ HỆ THỐNG", fonts.RobotoRegular.fontName, 40);
                this.addText(this.pn_baotriHeThong, "tx_cham1", cc.p(825, 360), ".", fonts.RobotoRegular.fontName, 40);
                this.addText(this.pn_baotriHeThong, "tx_cham2", cc.p(835, 360), ".", fonts.RobotoRegular.fontName, 40);
                this.addText(this.pn_baotriHeThong, "tx_cham3", cc.p(845, 360), ".", fonts.RobotoRegular.fontName, 40);
                this.addText(this.pn_baotriHeThong, "tx_chamthan", cc.p(865, 360), "/", fonts.RobotoRegular.fontName, 40);
